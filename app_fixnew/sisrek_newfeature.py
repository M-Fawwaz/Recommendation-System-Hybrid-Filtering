...
#     with col1:
#         option_restaurant = st.selectbox('Opsi pencarian', ["Japanese", "Chinese", "Western", "Indonesia"] + ["Restoran yang belum diberi rating"] + ["Restoran paling populer"] + all_restaurant, key='search all restaurant')
...
#         # Tambahkan selectbox untuk preferensi makanan
#         preferensi_makanan = st.selectbox('Pilih Preferensi Makanan', ["Semua", "Japanese", "Chinese", "Western", "Indonesia"], key='preferensi_makanan')
...
#     # Filter hasil berdasarkan pencarian dan preferensi makanan
#     if search_query:
...
#         if option_restaurant == "Semua":
#             restaurant_df = unrated_restaurants
#         else:
#             if preferensi_makanan == "Semua":
#                 filtered_places = places_to_eat
#             else:
#                 filtered_places = places_to_eat[places_to_eat['Preferensi Makanan'].str.contains(preferensi_makanan, case=False)]
            
#             restaurant_df = filtered_places.merge(unrated_restaurants[['Nama Restoran']], on='Nama Restoran', how='left')
